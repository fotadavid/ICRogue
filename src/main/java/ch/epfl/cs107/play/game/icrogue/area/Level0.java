...
public class Level0 extends Level{
    ...
    private void generateMap2() {
        ...
        setRoomConnector(room00, "icrogue/level010", Level0Room.Level0Connectors.E);
        lockRoomConnector(room00, Level0Room.Level0Connectors.E, BOSS_KEY_ID);
        ...
        lockRoomConnector(room10, Level0Room.Level0Connectors.E, BOSS_KEY_ID);
        openRoomConnector(room10, Level0Room.Level0Connectors.S);
        ...
        lockRoomConnector(room20, Level0Room.Level0Connectors.W, BOSS_KEY_ID);
        ...
        lockRoomConnector(room30, Level0Room.Level0Connectors.W, BOSS_KEY_ID);
        ...
        openRoomConnector(room11, Level0Room.Level0Connectors.N);
    }
}
